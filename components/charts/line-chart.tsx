...
export function LineChart({
  ...
  const chartTheme = useMemo(
    () => ({
      ...
      brushFill: isDark ? 'rgba(148, 163, 184, 0.12)' : 'rgba(59, 130, 246, 0.1)',
      brushBorder: isDark ? 'rgba(148, 163, 184, 0.38)' : 'rgba(59, 130, 246, 0.5)',
    }),
    [isDark]
  )
      ...
      series: series.map(item => {
        ...
        return {
          ...
          areaStyle: item.areaFill
            ? {
                opacity: item.opacity ?? (isDark ? 0.14 : 0.2),
